...
<head>
    ...
    <title>Modificar Datos - Control Diabetes</title>
                    ...
                    <ul class="nav-list">
                        ...
                        <li class="nav-item dropdown" id="nav-control">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="modificar.php" class="active">Modificar</a></li>
    ...
    <main class="main-content">
        <div class="forms-container">
            <div class="forms-header">
                <h1 class="forms-title">Modificar Datos de Control</h1>
                <p class="forms-subtitle">
                    Actualiza la información de tu control de diabetes de forma segura
                </p>
            </div>

            <div class="forms-grid">
                <!-- Modificar Control de Glucosa -->
                <div class="form-section control-glucose">
                    <div class="form-section-header">
                        ...
                        <h2 class="form-section-title">Modificar Control de Glucosa</h2>
                        <p class="form-section-subtitle">Actualiza tu nivel de actividad y glucosa basal</p>
                    </div>
                    <div class="form-section-body">
                        <form action="guardar_modificaciones.php" method="POST" id="modifyControlForm">
                ...
                <div class="form-section comida">
                    <div class="form-section-header">
                        ...
                        <h2 class="form-section-title">Modificar Comida</h2>
                        <p class="form-section-subtitle">Actualiza los datos de tus comidas</p>
                    </div>
                    <div class="form-section-body">
                        <form action="guardar_modificaciones.php" method="POST" id="modifyComidaForm">
                            <div class="form-group">
                ...
                <div class="form-section hipoglucemia">
                    <div class="form-section-header">
                        ...
                        <h2 class="form-section-title">Modificar Hipoglucemia</h2>
                        <p class="form-section-subtitle">Actualiza los datos de episodios de hipoglucemia</p>
                    </div>
                    <div class="form-section-body">
                        <form action="guardar_modificaciones.php" method="POST" id="modifyHipoForm">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       required
                                       placeholder="Ej: 65">
                                <div class="help-text">Nivel de glucosa durante el episodio de hipoglucemia</div>
                            </div>
                            ...
                            <button type="submit" name="submit_hipoglucemia" class="form-button form-button-primary">
                                ...
                                Actualizar Hipoglucemia
                            </button>
    </form>
                    </div>
                </div>

                <!-- Modificar Hiperglucemia -->
                <div class="form-section hiperglucemia">
                    <div class="form-section-header">
                        ...
                        <h2 class="form-section-title">Modificar Hiperglucemia</h2>
                        <p class="form-section-subtitle">Actualiza los datos de episodios de hiperglucemia</p>
                    </div>
                    <div class="form-section-body">
                        <form action="guardar_modificaciones.php" method="POST" id="modifyHiperForm">
                            <div class="form-group">
